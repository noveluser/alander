...
def init():
    ...
    for i in range(188):
        # sqlquery = "insert into ics.plcname_contrast (plcname, sortname)  values ('{}', '{}')".format(plcname_list[i], sortname_list[i])
        addDelayBag = "insert into ics.plcname_contrast (plcname, sortname) values ('{}', '{}'); ".format(plcname_list[i], sortname_list[i])
        queryResult = cursor.run_query(addDelayBag)
        # print(queryResult)
        # print("new {}--- sort {}".format(plcname_list[i], sortname_list[i]))

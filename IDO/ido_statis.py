...
def main():
    sqlquery = "SELECT EVENTTS, AREAID,ZONEID,EQUIPMENTID,STATISTICALID,VALUE FROM  WC_STATISTICALDATA  WHERE AREAID = 3111  and EQUIPMENTID = 99 and EVENTTS  > TRUNC(SYSDATE-1) and EVENTTS  < TRUNC(SYSDATE) "

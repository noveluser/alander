...
def main():
    sheetName = 'Sheet1'
    df = pd.read_excel("d://data//rso//202205/raw.xlsx", sheet_name=sheetName)
    ...
    for idx, row in df.iterrows():    # 迭代数据 以键值对的形式 获取 每行的数据
        ...
        if event == "ICS-PUSHED-LOSTANDFOUND":
            ...
            #     continue
    # print(pullIDgroup)
    matchPushDf.to_excel("d://data//rso//202205/matchPush_test.xlsx")
    matchPullDf.to_excel("d://data//rso//202205/matchPull_test.xlsx")
    notmatchPushDf.to_excel("d://data//rso//202205/notmatchPush_test.xlsx")
    notmatchPullDf.to_excel("d://data//rso//202205/notmatchPull_test.xlsx")

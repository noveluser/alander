...
def execute_batch_insert(connection, cursor, batch_data):
    ...
    (report_time, secucode, fixed_asset, total_assets, 
...
def getdata(stock_code):
    ...
    try:
        ...
        # 检查必要的列是否存在
        required_balance_cols = ["REPORT_DATE", "SECUCODE", "FIXED_ASSET", "TOTAL_ASSETS", 
...
def main():
    ...
    for stock_code in stock_codes:
        ...
        try:
            ...
            # 更新最新数据
            data = data[data["REPORT_DATE"].astype(str).str.startswith("2025-12-31")]
